    ...
    <section className="py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto relative">
          <div className="nebo-card p-8 md:p-14 relative overflow-hidden min-h-[320px] flex flex-col justify-center">
            {/* Background quote */}
            ...
            <AnimatePresence mode="wait" custom={direction}>
              ...
              >
                ...
                <div className="flex items-center gap-1 mb-6">
                  ...
                  <span className="ml-3 text-xs font-semibold tracking-wider uppercase text-purple-400 bg-purple-500/10 px-3 py-1 rounded-full">
                    {testimonial.projectType}
                  </span>
                </div>

                {/* Quote */}
                <blockquote className="text-lg md:text-xl text-gray-300 leading-relaxed mb-8 font-light italic">
                  "{testimonial.quote}"
                </blockquote>
          ...
          <div className="flex items-center justify-between mt-8">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={goPrev}
                className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:border-purple-500/50 transition-all"
